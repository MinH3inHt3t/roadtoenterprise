<template>
	<div class="relative">
		<div v-show="isGlobalSpinnerVisible" class="
        z-40
        h-screen
        w-screen
        ...
        justify-center
      ">
			<div class="w-64 h-48 bg-white rounded-lg flex items-center justify-center">
				<!-- Spinner -->
				<svg class="animate-spin h-12 w-12 text-indigo-700" xmlns="http://www.w3.org/2000/svg" fill="none"
					viewBox="0 0 24 24">
					<circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
					<path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962
...
<script>
	...
	export const useGlobalSpinner = () => {
		...
		if (!value) {
			throw new Error(`useGlobalSpinner must be used inside of
